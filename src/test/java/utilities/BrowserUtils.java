...
public class BrowserUtils {
     ...
     */
//    public static void waitForPageToLoad(long timeOutInSeconds) {
//        ExpectedCondition<Boolean> expectation = driver -> (boolean) ((JavascriptExecutor) driver).executeScript("return document.readyPage");
//        WebDriverWait wait = new WebDriverWait(Driver.getDriver(), timeOutInSeconds);
//        try {
//
//            wait.until(expectation);
...
//    }
    ...
    public static String getScreenshot(String name) {
        ...
        String path = System.getProperty("user.dir") + File.separator + "test-output" + File.separator + "screenshots" + File.separator + name + ".png";
